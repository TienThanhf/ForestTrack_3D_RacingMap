...
import { TransformMode } from '../systems/TransformSystem.js';
...
export class ModeControls {
  constructor({
    ...
    this.renderTargetSelect.addEventListener('change', () => {
      ...
      this.transformSystem.selectTarget(this.renderTargetSelect.value);
    });
  ...
  update(mode) {
    ...
    this.label.textContent = isRaceMode
      ? 'Race Mode: W/A/S/D or arrows drive. Esc returns.'
      : 'Explore Mode: orbit with mouse. C starts race.';
